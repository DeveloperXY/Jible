...
import "./mySkheras.css";
import MySkheraMapContainer from "./MySkheraMapContainer";

const MySkheras = ({ skheras }) => (
  <div className="my-skheras-container">
    {skheras.map((skhera, index) => (
      <div className="my-skheras" key={skhera._id}>
